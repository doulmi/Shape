#ifndef __SEGMENT_READER_H__
#define __SEGMENT_READER_H__
 ...
 * C'est le reader spécial pour traiter le polygone
 */
class SegmentReaderChain : public ShapeReaderChain {
public:
	/** 
