#ifndef __GROUP_READER_H__
#define __GROUP_READER_H__
 ...
 * C'est le reader spécial pour traiter le group
 */
class GroupReaderChain : public ShapeReaderChain {
public:
	/** 
